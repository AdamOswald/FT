...
models = [
     ...
     Model("Genshin Mona", "Eppinette/Mona", "Mona, Mona Woman, Mona Genshin"),
     ...
     Model("Lumine Genshin", "Fampai/lumine_genshin_impact", "Lumine_genshin, Lumine_Genshin, Lumine, Lumine Genshin, lumine"),
     Model("Ganyu Genshin", "sd-concepts-library/ganyu-genshin-impact", "Ganyu, Ganyu Woman, Ganyu Genshin"),
     Model("Raiden/Ei Genshin", "Fampai/raiden_genshin_impact", "Raiden Ei, raiden_ei, Raiden, Raiden Genshin, Ei Genshin, Raiden_Genshin, Ei_Genshin, Ei"),
     Model("Genshin HuTao", "Fampai/hutao_genshin_impact", "hutao_genshin, HuTao_Genshin, HuTao Genshin, HuTao"),
     Model("Genshin Waifu", "Fampai/lumine_genshin_impact, Eppinette/Mona, sd-concepts-library/ganyu-genshin-impact, Fampai/raiden_genshin_impact, Fampai/hutao_genshin_impact, crumb/genshin-stable-inversion, yuiqena/GenshinImpact, katakana/2D-Mix, Guizmus/AnimeChanStyle", "Female, female, Woman, woman, Girl, girl"),
